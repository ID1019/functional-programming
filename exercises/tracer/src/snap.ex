defmodule Snap do
  ...
  def snap(3) do
    ...
    obj1 = Sphere.sphere(140, {0, 0, 700}, [{:color, {1, 0.5, 0}}, {:brilliance, 1.0}])
    obj2 = Sphere.sphere(50, {200, 0, 600}, [{:color, {0, 0.8, 0.2}}, {:brilliance, 0.4}])
    obj3 = Sphere.sphere(50, {-80, 0, 400}, [{:color, {0.1, 0.1, 1}}, {:brilliance, 0.8}])

    light1 = Light.light({-1000, -1000, 300}, {1.0, 0.3, 0.3})
    light2 = Light.light({800, 800, 0}, {0.3, 1.0, 0.3})
    light3 = Light.light({800, -800, 0}, {0.3, 0.3, 1.0})
