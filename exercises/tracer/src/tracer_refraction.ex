  ...
  defp trace_ray(ray, cntr, depth, x1, world) do
    ...
    case intersect(ray, objects) do
      ...
      {d, obj} -> 
        ...
        visible = visible(i1, World.lights(world), objects)
        illumination = Light.combine(i1, normal,  visible)
        r1 = Ray.ray(i1, reflection(l, normal))
        reflection = trace_ray(r1, cntr * Sphere.brilliance(obj), depth - 1, x1, world)
        x2 = Sphere.refraction(obj)
        ...
        case refraction(l, x1, x2, normal) do
          ...
          refr ->
            ...
            r2 = Ray.ray(i2, refr)
            refraction = trace_ray(r2, cntr * Sphere.brilliance(obj), depth - 1, x2, world)
