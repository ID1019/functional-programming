...
\begin{columns}
 \begin{column}{0.6\linewidth}
   ...
   \begin{itemize}
   \item Introduction - basic functions, get the system up and running.
   \item Derivative - representing data, recursion. 
   \item Trees and lists - and more recursion.
   \item Primes - Eratosthenes sieve. 
   \item Advent of Code - fun.
   \item Train shunting - puzzle programming.
 ...
 \begin{column}{0.4\linewidth}
   ...
   \pause
   Hand in after seminars:
   \begin{itemize}
   \item Ray-tracer
   \item Mandelbrot 
   \item The final assignment :-0
   \end{itemize}
